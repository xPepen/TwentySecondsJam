...
namespace TNRD
{
    ...
    public class SerializableInterface<TInterface> : ISerializableInterface where TInterface : class
    {
        ...
        public SerializableInterface<TInterface> ShallowCopy()
        {
            return new SerializableInterface<TInterface>
            {
                mode = this.mode,
                unityReference = this.unityReference,
        ...
        public static implicit operator bool(SerializableInterface<TInterface> interfaceObject)
        {
            return interfaceObject.Value != null;
        }
    }
}
